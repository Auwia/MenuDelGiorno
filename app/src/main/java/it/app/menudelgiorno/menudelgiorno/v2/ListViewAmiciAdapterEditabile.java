...
public class ListViewAmiciAdapterEditabile extends ArrayAdapter<Amico> {
	...
	public ListViewAmiciAdapterEditabile(Context context, ArrayList<Amico> listaAmici) {
